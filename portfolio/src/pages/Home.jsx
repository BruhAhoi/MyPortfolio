      ...
      <main className="min-h-screen pt-16 relative overflow-hidden">
        ...
        <section className="max-w-6xl mx-auto px-6 py-24 md:py-36 relative">
          ...
          >
            ...
            <motion.div variants={item} className="flex flex-wrap gap-4">
              ...
              <Link
                to="/resume"
                className="px-6 py-3 border border-border hover:border-accent/50 text-text font-medium rounded-xl transition-all duration-200 hover:bg-surface bg-surface"
              >
                Hồ Sơ Chi Tiết
              </Link>
              <a
                ...
                className="px-6 py-3 border border-border hover:border-accent/50 text-text font-medium rounded-xl transition-all duration-200 hover:bg-surface bg-surface flex items-center gap-2"
              >
                GitHub ↗
              </a>
            </motion.div>
          ...
          >
            <div className="w-56 h-72 rounded-2xl border border-accent/20 overflow-hidden glow bg-gradient-to-br from-accent/20 to-blue-600/10 flex items-center justify-center">
              {personal.avatar ? (
                <img
                  src={personal.avatar}
                  loading="lazy"
                ...
                <span className="font-display text-6xl font-bold text-gradient select-none">
                  TDT
                </span>
              )}
            </div>
        ...
        <section className="border-t border-border py-10 overflow-hidden">
          <div className="max-w-6xl mx-auto px-6">
            <p className="text-xs text-muted uppercase tracking-widest mb-6 font-mono">
              Tech Stack
            </p>
